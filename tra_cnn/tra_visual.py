...
data_file = '..\\data\\orignal-data\\train_final.csv'
...
for idx, k in enumerate(range(len(trajectory_dict))):
    ...
    grid_map = np.full((240, 180), 999)  # 底色矩阵图片
    ...
    for dot in grid_line:
        ...
        grid_map[long_idx][wide_idx] -= 100  # 在矩阵图片上，该点数值累积变小
